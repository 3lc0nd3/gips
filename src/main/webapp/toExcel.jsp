...
<%@ page import="co.com.lh.smsfin.model.Outbox" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="org.hibernate.criterion.DetachedCriteria" %>
<%@ page import="org.hibernate.criterion.Restrictions" %>
<%@ page import="java.util.Calendar" %>
<jsp:useBean id="smsManager" class="co.com.lh.smsfin.dao.FacDAO" scope="application"/>
...
//            logger.debug("outbox.getId() = " + outbox.getId());
        ...
        <table border="1">
            <tr height="80">
                <td bgcolor="<%=bgColor%>" colspan="7" align="center">
                    <img
                            <%--src="http://localhost:8080/smsfin/img/logos_header.jpg" --%>
                            src="http://www.catedraenlinea.com/images/logos_header.jpg"
                            <%--src="http://lhapp.dyndns.org:8080/smsfin/img/log_out.jpg" --%>
                            width="525" height="75">
                </td>
            </tr>
<%
